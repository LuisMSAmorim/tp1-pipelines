...
/**
 * Serviço que fornece operações matemáticas básicas. Esta classe é final para garantir que não seja estendida, já que
 * não foi projetada para extensão.
 */
public final class CalculatorService {
     ...
     *
     * @param a
     *            o número do qual será subtraído
     * @param b
